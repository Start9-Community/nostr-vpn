...
if ('${NVPN_WINDOWS_SERVICE_TOGGLE_SKIP_BUILD:-0}' -notmatch '^(1|true|yes|on)$') {
...
if (!(Test-Path \$app)) { throw ('Windows release app not found: {0}' -f \$app) }
