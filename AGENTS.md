...
- Physical iOS XCTest: keep the same UI runner installed between cases; uninstalling the last development-signed runner drops device trust and blocks later Xcode launches.
