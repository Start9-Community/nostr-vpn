...
- Physical iOS XCTest: after reboot, approve the first XCTest “Enable UI Automation” prompt once; keep that runner installed because removing the last development-signed runner drops trust.
